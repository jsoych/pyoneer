...
json_value *worker_status_map(int status)
{
    ...
    {
    case WORKER_NOT_ASSIGNED:
        return json_string_new("not_assigned");
    case WORKER_ASSIGNED:
        return json_string_new("assigned");
    case WORKER_NOT_WORKING:
        return json_string_new("not_working");
    case WORKER_WORKING:
        return json_string_new("working");
    }
    return NULL;
}
...
int worker_status_decode(const json_value *value)
{
    ...
    int code = (strcmp(str, "not_assigned") == 0) ? WORKER_NOT_ASSIGNED : (strcmp(str, "not_working") == 0) ? WORKER_NOT_WORKING
